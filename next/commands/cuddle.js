...
export default {
  name: 'cuddle',
  aliases: ['carinho'],
  description: 'Envia um GIF de "cuddle" para o alvo mencionado.',
  args: true,
  args_length: 1,
  command_example: 'cuddle @luiz',
  group_only: true,
  ...
  execute: async ({ client, message, args }) => {
    ...
    try {
      ...
      const neko = await new NekoClient().fetch('cuddle', 1);
      ...
      const caption = `🥰 ${sender.pushname} fez carinho em ${
      ...
      console.error('❌ Erro no comando /cuddle:', err);
