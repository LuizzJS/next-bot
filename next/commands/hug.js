...
export default {
  ...
  description: 'Envia um GIF de "hug" para o alvo mencionado.',
  args: true,
  args_length: 1,
  command_example: 'hug @luiz',
  group_only: true,
  ...
  execute: async ({ client, message, args }) => {
    ...
    try {
      ...
      const neko = await new NekoClient().fetch('hug', 1);
      ...
      const caption = `🫂 ${sender.pushname} deu um abraço em ${
      ...
      console.error('❌ Erro no comando /hug:', err);
