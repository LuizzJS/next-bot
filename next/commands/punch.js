...
export default {
  name: 'punch',
  aliases: ['soco'],
  description: 'Envia um GIF de "punch" para o alvo mencionado.',
  args: true,
  args_length: 1,
  command_example: 'punch @luiz',
  group_only: true,
  ...
  execute: async ({ client, message, args }) => {
    ...
    try {
      ...
      const neko = await new NekoClient().fetch('punch', 1);
      ...
      const caption = `🥊 ${sender.pushname} deu um soco em ${
      ...
      console.error('❌ Erro no comando /punch:', err);
